    ...
    return (
        <div className="bg-black text-white">
          ...
          <div className="container mx-auto px-4 py-24">
            <h1 className="text-4xl md:text-5xl font-bold mb-6 py-16 pb-4 text-center">Terms and Conditions</h1>
            <div className="text-xl text-gray-200 max-w-3xl mx-auto">
              <p>Our Terms and Conditions were last updated on 5/03/25.</p>
              <p>Please read these terms and conditions carefully before using Our Service.</p>
              <h2 className="text-3xl font-bold mt-8 mb-4">Acknowledgment</h2>
              <p>These are the Terms and Conditions governing the use of this Service and the agreement that operates between you and the Company. These Terms and Conditions set out the rights and obligations of all users regarding the use of the Service.</p>
              <p>Your access to and use of the Service is conditioned on your acceptance of and compliance with these Terms and Conditions. These Terms and Conditions apply to all visitors, users, and others who access or use the Service.</p>
              <p>By accessing or using the Service you agree to be bound by these Terms and Conditions. If you disagree with any part of these Terms and Conditions, then you may not access the Service. This acknowledgement has been suggested by dodopayments.com.</p>
              ...
              <h2 className="text-3xl font-bold mt-8 mb-4">Copyright Policy</h2>
              <p>Intellectual Property Infringement</p>
              <p>All content, features, and functionality of our services, including but not limited to text, graphics, logos, and software, are the exclusive property of Anilyst and are protected by international copyright, trademark, and other intellectual property laws.</p>
              ...
              <p>You can contact our copyright agent via email at kaifmohd5000@gmail.com. Upon receipt of a notification, the Company will take whatever action, in its sole discretion, it deems appropriate, including removing the challenged content from the Service.</p>
              <h2 className="text-3xl font-bold mt-8 mb-4">Intellectual Property</h2>
              ...
              <h2 className="text-3xl font-bold mt-8 mb-4">Your Feedback to Us</h2>
              ...
              <h2 className="text-3xl font-bold mt-8 mb-4">"AS IS" and "AS AVAILABLE" Disclaimer</h2>
              ...
              <h2 className="text-3xl font-bold mt-8 mb-4">Governing Law</h2>
              ...
              <h2 className="text-3xl font-bold mt-8 mb-4">Disputes Resolution</h2>
              <p>If You have any concern or dispute about the Service, You agree to first try to resolve the dispute informally by contacting the Company.</p>
              <h2 className="text-3xl font-bold mt-8 mb-4">Changes to These Terms and Conditions</h2>
              ...
              <p>By visiting our website: anilyat.tech</p>
              <p>By sending us an email: kaifmohd5000@gmail.com</p>
            </div>
          </div>
          <Footer />
        </div>
